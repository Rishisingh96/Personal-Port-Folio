...
const About = () => {
  const [data, setData] = useState({
    ...
    desc1: `I am proficient in Java, Servlet, JSP, JavaScript, C, C++, CSS, HTML & SQL, JDBC. Starting to learn "Spring
      ...
      <div className="main-container bg-gray-100 border py-16">
        ...
        <div className="flex items-center">
          ...
          <div className="w-full flex justify-center">
            <img
              className=" rounded-full my-2 shadow-lg h-45 w-40"
              src={data.image}
              alt="Rishi singh"
            />
          </div>
